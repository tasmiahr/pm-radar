...
1. Calls the right API scraper for each company (Greenhouse / Lever / Ashby)
1. Saves every job to data/jobs.db (deduplicates — safe to re-run)
1. Logs each run to the scrape_runs table
